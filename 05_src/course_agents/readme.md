# Course Agents: A Sample Response
...
- `05_src/course_agents/*.py` course source code
...
- Assignment paths are saved in `05_src/course_agents/last_path.json` and restored on restart.
- Feedback files are written to `05_src/course_agents/feedback/`.
